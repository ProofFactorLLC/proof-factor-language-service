...
var TimeService = /** @class */ (function() {
  ...
  TimeService.prototype.ago = function(value, locale) {
    return locale ? timeago.format(value, locale) : timeago.format(value);
  };
  TimeService.prototype.registerLocale = function(locale) {
    var _this = this;
    return new Promise(function(resolve, reject) {
      if (_this.registeredLocales.includes(locale)) {
        resolve();
      }
      TimeService.loadLocaleFunction(locale)
  ...
  TimeService.loadLocaleFunction = function(locale) {
    switch (locale) {
      case 'de':
